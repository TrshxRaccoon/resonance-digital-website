    ...
    <footer className={`${backgroundClass} ${textClass}`}>
      <div className="max-w-[1400px] mx-auto px-16 pt-24 pb-20 grid grid-cols-1 lg:grid-cols-2 gap-28 items-start">
        ...
        <div className="flex flex-col items-start">
          ...
          {/* ADDRESS + PHONE */}
          <div
            className={`border-t mt-4 pt-8 grid grid-cols-1 sm:grid-cols-2 gap-16 text-sm ${borderClass}`}
          >
            <div>
        ...
        <div className="flex flex-col pt-28">
          ...
          <div className="flex gap-8 mt-0 mb-6">
            {[
              ...
              {
                icon: <FacebookIcon />,
                href: "https://www.facebook.com/share/1D13tnZctJ/",
              },
              {
                icon: <YoutubeIcon />,
                href: "https://www.youtube.com/@Resonance2016",
              },
              {
                icon: <InstagramIcon />,
                href: "https://www.instagram.com/resonancedigital/",
              },
              {
                icon: <LinkedInIcon />,
                href: "https://www.linkedin.com/company/resonance-digital/",
              },
            ].map((item, i) => (
              <a
                key={i}
          ...
          <div className={`border-t pt-8 mt-2 ${borderClass}`}>
            <p className={`text-xs uppercase mb-8 ${subtleTextClass}`}>
              Contact with us
            </p>
      ...
      <div
        className={`border-t py-8 text-center text-xs ${borderClass} ${isDark ? "text-[#f2eee2]/60" : "text-black/60"}`}
      >
